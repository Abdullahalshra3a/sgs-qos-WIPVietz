...
class SolutionCandidates():
    ...
    def create_all_solution_candidates(self):
        ...
        for t in self.topology:
            if t == Topology.CENTRAL:
                ...
                self.overlay_connections = util.compose_end_to_end_connection(self.servers, self.field_devices)#[('S2', 'F12'), ('S2', 'F34'), ('S2', 'F22')]
                for server in self.servers:
                    fd_multi_paths = self.get_fd_paths(server)#[[['F16', 'R11', 'R10', 'R20', 'R21', 'S2'], ['F16', 'R11', 'R10', 'R30', 'R20', 'R21', 'S2']], [['F32', 'R32', 'R30', 'R10', 'R20', 'R21', 'S2'], ['F32', 'R32', 'R30', 'R20', 'R21', 'S2'], ['F32', 'R32', 'R31', 'R30', 'R10', 'R20', 'R21', 'S2'], ['F32', 'R32', 'R31', 'R30', 'R20', 'R21', 'S2']], [['F25', 'R24', 'R22', 'R21', 'S2'], ['F25', 'R24', 'R23', 'R21', 'S2']]]
    ...
    def create_singlepath_candidates(self, multi_paths, server):
        ...
        for l in latencies:
            lat += l
        m_path = []#['F11', 'R12', 'S1'], ['F15', 'R11', 'R12', 'S1'], ...etc
        for m in adjusted_multipaths:
            m_path += m
        br = []#[<networkx.classes.graph.Graph object at 0x000001D1EB71CAC0>, <networkx.classes.graph.Graph object at 0x000001D1EB71CB20>,..etc.
    ...
    def create_candidates(self, latencies, adjusted_multipaths, adj_bitrate_graphs, server):
        ...
        for element in latencies:
            if ctr_list <= stop_generation - 1:
                ...
                ctr_list += 1# the following line condition is not sttasfied, 1 mod 1000 = 1
